...
pass.placeholder = "Ingresa una contraseña";
pass2.placeholder = "Introduce de nuevo contrase";
...
function tiene_mayus(texto) {
 ...
 form.addEventListener("submit", e => {
     ...
     if (!regexemail.test(email.value)) {// Metodo para que tenga minimo 6 caracteres en el nombre de usuario
    ...
    if (pass.value.length < 8) { // Validacion para contrasena 8 carac min
